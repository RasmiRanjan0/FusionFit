  ...
  return (
    <section className="relative w-full h-screen bg-black text-white flex items-center justify-center overflow-hidden ">
      ...
      <Motion.h1
        ...
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.8, ease: 'easeOut' }}
        className="z-10 text-[14vw] font-bold text-white leading-none text-center"
      >
        FUSION FITNESS
      </Motion.h1>
      ...
      <Motion.div
        ...
        className="absolute bottom-12 left-6 text-xs sm:text-sm text-white font-medium z-10 text-left 2xl:pl-[12%] "
      >
      ...
      <Motion.div
        ...
        className="absolute bottom-12 right-6 flex items-center gap-4 text-lg z-10 2xl:pr-[12%]"
      >
