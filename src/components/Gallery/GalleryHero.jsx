...
//         src="/images/Gallery/gallery-hero.jpg" // Make sure the path exists
...
//         animate={{ opacity: 1 }}
//         transition={{ duration: 1.2, ease: 'easeOut' }}
//         src="/images/Gallery/gallery-hero.jpg" // Update with your actual path
//         alt="Gallery Hero Background"
//         className="absolute inset-0 w-full h-full object-cover"
//       />
...
//       >
//         <h1 className="text-[12vw] lg:text-[8vw] font-bold tracking-wider text-center leading-none">
//           GALLERY
//         </h1>
//       </Motion.div>

//       {/* Bottom Left Text */}
//       <div className="absolute bottom-15 2xl:bottom-6 left-6 sm:left-12 z-20 text-[11px] sm:text-xs font-medium tracking-widest leading-snug max-w-[160px]  2xl:pl-[6.6%]">
//         <p>DISCOVER OUR</p>
//         <p>WORKOUTS, MOMENTS,</p>
//         <p>AND COMMUNITY</p>
//       </div>
...
const GalleryHero = () => {
  return (
    <section className="relative w-full h-screen overflow-hidden text-white">
      ...
      {/* Bottom-right Social Icons Motion */}
      <Motion.div
