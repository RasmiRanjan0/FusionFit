...
//         whileInView="show"
//         viewport={{ once: true }}
//         className="flex sm:hidden gap-4 overflow-x-auto pb-4 -mx-6 px-6"
//       >
//         {services.map((item, index) => (
//           <Motion.div
//             key={index}
//             variants={cardVariants}
//             className="min-w-[280px] flex-shrink-0 relative group rounded-xl overflow-hidden bg-[#2B2B2B] h-[400px] flex items-end"
//           >
//             <img
//               src={item.image}
//               alt={item.title}
...
//             />
//             <div className="absolute inset-0 bg-gradient-to-t from-black/90 to-transparent z-10" />
//             {/* Arrow - show only on sm+ */}
//             <div className="absolute right-6 bottom-6 z-20 text-white text-xl font-semibold hidden sm:block">
//               →
//             </div>
//             <div className="relative z-20 p-6">
...
//         whileInView="show"
//         viewport={{ once: true }}
//         className="hidden sm:grid gap-6 sm:grid-cols-2 lg:grid-cols-3 max-w-[1440px] mx-auto"
//       >
//         {services.map((item, index) => (
//           <Motion.div
//             key={index}
...
//             />
//             <div className="absolute inset-0 bg-gradient-to-t from-black/90 to-transparent z-10" />
//             <div className="absolute right-12 bottom-6 z-20 text-white text-xl font-semibold hidden sm:block">
//               →
//             </div>
//             <div className="relative z-20 p-6">
//               <h3 className="text-lg md:text-xl font-semibold text-white">{item.title}</h3>
...
//             <Card1 image={item.image} title={item.title} />
//           </Motion.div>
//         ))}
//       </Motion.div>
  ...
  return (
    <section className="px-6 py-16 md:px-20 text-white">
      ...
      <Motion.div
        ...
        whileInView="show"
        viewport={{ once: true }}
        className="flex sm:hidden gap-4 overflow-x-auto pb-4 -mx-6 px-6 scroll-smooth snap-x snap-mandatory hide-scrollbar"
      >
        {services.map((item, index) => (
          <Motion.div key={index} variants={cardVariants} className="snap-center">
            <Card1 image={item.image} title={item.title} />
          </Motion.div>
        ))}
      </Motion.div>
