...
//         whileInView="show"
//         viewport={{ once: true }}
//         className="flex sm:hidden gap-4 overflow-x-auto -mx-6 px-6 pb-4"
//       >
//         {trainers.map((trainer, index) => (
//           <Motion.div
//             key={index}
...
//             transition={{ type: 'spring', stiffness: 200 }}
//           >
//             <Card2 image={trainer.image} title={trainer.name} subtitle={trainer.title} />
//           </Motion.div>
//         ))}
//       </Motion.div>
...
//         whileInView="show"
//         viewport={{ once: true }}
//         className="hidden sm:grid sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-[1440px] mx-auto"
//       >
//         {trainers.map((trainer, index) => (
//           <Motion.div
//             key={index}
...
//         whileInView="show"
//         viewport={{ once: true }}
//         className="flex sm:hidden gap-4 overflow-x-auto pb-4 px-2 -mx-2 scroll-smooth snap-x snap-mandatory"
//       >
//         {trainers.map((trainer, index) => (
//           <Motion.div
//             key={index}
  ...
  return (
    <section className="bg-black text-white px-4 sm:px-6 md:px-20 py-16 text-center">
      ...
      <Motion.div
        ...
        whileInView="show"
        viewport={{ once: true }}
        className="flex sm:hidden gap-4 overflow-x-auto pb-4 px-2 -mx-2 scroll-smooth snap-x snap-mandatory hide-scrollbar"
      >
        {trainers.map((trainer, index) => (
          <Motion.div
            key={index}
